...
# The initial code was posted to the ggplot2 mailing list 
# by Osmo Salomaa in 2010, who later updated it to reflect changes 
# in ggplot2 syntax. 
# Use it by passing ggplot(...) + ... + theme_map().
